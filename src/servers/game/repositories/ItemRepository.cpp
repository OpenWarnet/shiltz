...
{
void SaveEquipmentSlot(IDatabase& db, std::int64_t characterId, std::uint32_t slot,
                       const Item& item)
{
...
void SaveItemSlot(IDatabase& db, std::int64_t characterId, std::uint32_t wireSlotId,
                  const Item& item)
{
