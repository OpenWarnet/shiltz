...
#define OPCODE_NAME(name) \
    case Code::name:      \
        ...
        switch (code)
        {
            ...
            OPCODE_NAME(GC_CHAR_NEW)
            OPCODE_NAME(GC_CHAR_OTHER_LOAD)
            OPCODE_NAME(GC_CHAR_REMOVE)
            OPCODE_NAME(GC_ENTER_FAIL)
            OPCODE_NAME(GC_CRT_LOAD)
            OPCODE_NAME(GC_CRT_NEW)
            OPCODE_NAME(GC_CRT_REMOVE)
            OPCODE_NAME(GC_CRT_MOVE)
            OPCODE_NAME(GC_CRT_KILL_INFO)
            OPCODE_NAME(GC_ATTACK_TO_CRT_SUCC)
            OPCODE_NAME(GC_ATTACK_TO_CRT_KILL)
            OPCODE_NAME(GC_ATTACK_PC2CRT_SUCC)
