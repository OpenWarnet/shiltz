...
bool Player::LoadFromDB(IDatabase& db, std::int64_t characterId)
{
    ...
    // TODO: none of these four have a DB column yet -- placeholders.
    hp = 1000;
    ap = 500;
    fame = 2556;
    exp = 100;
...
namespace
{
    ...
    {
        auto stmt = db.Prepare("SELECT item_id, quantity, refine_level FROM inventory_slot "
